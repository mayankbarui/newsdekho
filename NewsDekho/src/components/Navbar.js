    ...
    <div className="collapse navbar-collapse" id="navbarSupportedContent">
      <ul className="navbar-nav me-auto mb-2 mb-lg-0">
        <li className="nav-item">
          ...
          {/* Link to ka v use kr skte hai hm niche commented word line se pta chlega k kaise krna hai */}
        {/* <li className="nav-item"> <Link to="/Business" className="nav-link">About</Link></li> */}
        ...
        <li className="nav-item"> <a className="nav-link" href="/Sports">Sport</a></li>
